...
const courses = [
  {
    ...
    programs: [
      ...
      { name: "MBA Master of Business Administration", link: "/business-school/master-business-administration" },
      { name: "BBA Bachelor of Business Administration", link: "/business-school/bachelor-business-administration" },
      { name: "BBA Aviation", link: "/business-school/bachelor-business-administration-aviation-management" },
      { name: "BBA+ CA / ACCA", link: "/business-school/bachelor-business-administration" },
    ],
  ...
  },
  {
    ...
    programs: [
      ...
      { name: "Master of Commerce MCOM", link: "/finance-commerce-school/master-of-commerce" },
      { name: "Bachelor of Commerce BCOM", link: "/finance-commerce-school/bachelor-of-commerce" },
      { name: "CA / ACCA BCOM+", link: "/finance-commerce-school/bachelor-of-commerce" },
    ],
  ...
  },
  {
    ...
    programs: [
      { name: "BHM Bachelor of Hotel Management", link: "/hospitality-tourism-school/bachelor-hotel-management" },
      {
  ...
  },
  {
    ...
    programs: [
      { name: "Master of Computer Application MCA", link: "/information-technology-school/master-computer-applications" },
      { name: "Bachelor of Computer Application BCA", link: "/information-technology-school/bachelor-computer-applications" },
      {
  ...
  },
  {
    ...
    programs2: [
      { name: "PCMB", link: "/pre-university-college/science-integrated-pcmb-pcmc-cet-neet-jee" },
      { name: "PCMC", link: "/pre-university-college/science-pcmb-pcmc" },
    ],
    programsTitle2: "COMMERCE",
    programs3: [{ name: "CEBA", link: "/pre-university-college/science-integrated-pcmb-pcmc-cet-neet-jee" }],
          ...
          <div className="flex flex-col w-full">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                 <Link href={courses[current].browseAllLink}>{courses[current].buttonText}</Link>
                </Button>
              </motion.div>
            </AnimatePresence>
