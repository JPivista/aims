  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
      ...
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-4 sm:mb-6">
        At AIMS Institutes, the Code of Conduct defines the expected academic
        and personal behavior of every student. We expect our students to
        reflect value-based conduct, emotional balance, and a maturity that
        contributes positively to the AIMS community.
      </p>

      {/* Standard paragraph */}
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-4 sm:mb-6">
        Students are encouraged to pursue personal excellence while upholding
        the reputation and objectives of the Institute.
      </p>
      ...
      {/* Standard paragraph */}
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-4 sm:mb-6">
        The management reserves the right to amend any policies as required. All
        updates will be communicated via official channels: circulars, notice
        boards, SMS, email, or student groups. For any clarification, students
        may reach out to the concerned persons.
      </p>
      ...
      {/* Standard paragraph */}
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-4 sm:mb-6">
        Off-campus misconduct may be treated as if it occurred on campus,
        depending on the seriousness and impact.
      </p>
      ...
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-3">
        Students must refrain from engaging in:
      </p>
      ...
      {/* Standard paragraphs */}
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-3">
        Students must maintain dignity and maturity in all inter-gender
        interactions.
      </p>
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-4 sm:mb-6">
        Electrical appliances and fixtures must be switched off when not in use.
      </p>
      ...
      {/* Sub-Sub-Heading */}
      <h5 className="text-base sm:text-lg md:text-[24px] text-[#0C2165] monser-500 mb-1 sm:mb-3">
        Dress Code
      </h5>
      ...
      {/* Standard paragraph */}
      <p className="text-base sm:text-lg md:text-xl lg:text-[18px] leading-relaxed monser-400 text-black mb-4 sm:mb-6">
        Students awaiting uniform distribution must wear formal attire.
      </p>

      {/* Sub-Heading */}
      <h5 className="text-base sm:text-lg md:text-[28px] text-[#0C2165] monser-500 mb-1 sm:mb-3">
        General Campus Etiquette
      </h5>
