  ...
  return (
    <>
      <div className="relative w-full h-[83vh] md:h-[76vh] overflow-hidden">
        ...
        <div className="hidden md:block w-full h-full bg-cover bg-top bg-no-repeat bg-[url('/iacbe/banner-03.png')]" />

        {/* Background Image - Mobile */}
        <div className="md:hidden w-full h-full bg-cover bg-top bg-no-repeat bg-[url('/iacbe/mobile.png')]" />
        ...
        <div className="absolute top-0 lg:top-20 left- lg:right-10 px-4 lg:px-0">
