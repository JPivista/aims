...
const CourseStructure = ({ programKey = "mba" }) => {
  ...
  const getProgramDescription = (programKey) => {
    const descriptions = {
      mba: "Comprehensive business education designed to develop leadership skills and strategic thinking for modern business challenges.",
