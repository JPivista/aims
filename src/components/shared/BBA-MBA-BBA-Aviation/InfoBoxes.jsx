          ...
          {boxes.map((box, index) => (
            ...
            >
              ...
              <div className="ml-4">
                ...
                <h5 className={`text-base ${titleColor} mb-2 monser-600 leading-tight`}>
                  {box.title}
                </h5>
                <p className={`text-sm ${descColor} monser-400 leading-relaxed`}>
                  {box.description}
                </p>
              </div>
            </div>
          ...
          {boxes.map((box, index) => (
            ...
            >
              ...
              <div className="ml-4 sm:ml-6 md:ml-8 group-hover:ml-2 transition-all duration-300">
                ...
                <h5 className={`text-xs md:text-base lg:text-[20px] ${titleColor} mb-1 sm:mb-2 monser-600 leading-tight`}>
                  {box.title}
                </h5>
                <p className={`text-[10px] md:text-sm lg:text-[14px] ${descColor} monser-400 leading-tight break-words`}>
                  {box.description}
                </p>
              </div>
            </div>
