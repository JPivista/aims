        ...
        {boxes.map((box, index) => (
          ...
          >
            ...
            <div className="absolute left-1 sm:left-2 top-2 bottom-2 opacity-100 group-hover:opacity-0 transition-opacity duration-300 flex items-center">
              <svg width="8" height="80" viewBox="0 0 8 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-1.5 sm:w-2 h-full">
            ...
            <div className="ml-4 sm:ml-6 md:ml-8">
              <div className="text-lg sm:text-xl md:text-2xl lg:text-[24px] font-bold mb-1 sm:mb-2" style={{ color: '#A22877', fontFamily: 'Helvetica Neue' }}>
                {box.number}
              </div>
