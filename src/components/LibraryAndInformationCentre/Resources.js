      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <span
              className={`transform transition-transform duration-300 ${
                isPlagiarismOpen ? "rotate-180" : "rotate-0"
              }`}
            >
              <FaChevronDown
                className={`transform transition-transform duration-300 ${
                  openSection === "plagiarism" ? "rotate-180" : "rotate-0"
                }`}
              />
            </span>
          </button>
        ...
        <div className="rounded-xl overflow-hidden">
          ...
          >
            ...
            <span
              className={`transform transition-transform duration-300 ${
                isBookRecommendationsOpen ? "rotate-180" : "rotate-0"
              }`}
            >
              <FaChevronDown
                className={`transform transition-transform duration-300 ${
                  openSection === "bookRecommendations"
                    ? "rotate-180"
                    : "rotate-0"
                }`}
              />
