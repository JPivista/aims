          ...
          <div className="lg:w-1/2 mx-auto">
            <div className="bg-[#FAE5E6] sm:h-full sm:w-[750px] xl:w-full md:w-[750px] lg:h-[540px] rounded-lg border border-[#A22877] p-8 relative">
              ...
              <div className="text-gray-800 space-y-4">
                <p className="text-lg">
                  Students will be considered ineligible for campus placements
                  if:
                </p>
                ...
                <ul className="list-disc list-outside space-y-2 ml-7">
                  ...
                  <li>
                    They don&apos;t complete 100% of pre-placement training
                  </li>
                  <li>
                ...
                <p className="text-lg mt-6">
                  Ineligible students will be considered for placements only
                  after all other students are placed. Re-entry into the process
                  depends on improved performance and approval by the placement
                  committee.
                </p>
              </div>
            </div>
