      ...
      <div className="bg-[#FCE6F499] ">
        <div className="container mx-auto px-4 md:px-0 py-6 md:py-10">
          ...
          <div className="flex flex-col lg:flex-row w-full gap-6 md:gap-0 mb-8 md:mb-12">
            ...
            <div className="flex flex-col space-y-3 w-full lg:w-4/5 ">
              <h2 className="text-4xl md:text-6xl playfair-300 text-[#0C2165] tracking-wider">
                Practical Skills.
                <br />
            ...
            <div className="w-full lg:w-1/3 flex items-center justify-start md:-ml-30">
