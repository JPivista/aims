...
import MbaOverviewTabs from "./MbaOverviewTabs"
        ...
        content: (
            <>
                ...
                <p className="text-gray-800 text-sm sm:text-base">
                    Here you can list important dates related to the MBA program, such as application deadlines, interview schedules, and admission timelines.
                </p>
            </>
        ),
    },
    {
        ...
        content: (
            <>
                ...
                <p className="text-gray-800 text-sm sm:text-base">Students seeking admission to MBA degree at AIMS Institutes must adhere to the guidelines of eligibility prior to submitting application form (online only) to us. All applications which do not meet our MBA selection criteria listed above will not be entertained.</p>
            </>
        ),
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6 pb-8 md:pb-12">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-between md:items-start md:items-center py-6 md:py-8">
          <h2 className="w-full md:w-2/5 mb-4 md:mb-0">
            <span className="mba-program-text text-3xl md:text-4xl leading-tight md:leading-tight">MBA Program</span>
            <br />
