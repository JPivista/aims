  ...
  return (
    <>
      <div className="relative w-full h-[100vh] md:h-[83vh] overflow-hidden">
        ...
        {/* Empower Image*/}
        <div className="absolute left-4 md:left-20 top-4 md:top-20 md:max-w-2xl">
        <Image
          src="/bba/empower.svg"
          alt="Empower"
          width={100}
        ...
        />
         ...
         <div className="absolute inset-0 w-full md:w-3/4 flex flex-col justify-end">
           <div className="container mx-auto px-4 md:px-20 py-8 md:py-14">
               ...
               <h3 className="playfair-300 text-[#C9FFF4] text-xl sm:text-2xl md:text-[60px] mt-2">Sharpen Your Aim. Step Into <br/> Business With Confidence.</h3>
