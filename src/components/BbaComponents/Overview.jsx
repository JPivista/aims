    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-gray-800 text-base sm:text-lg md:text-xl leading-relaxed lg:px-0 px-0">
            Please see the{" "}
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-gray-800 text-base sm:text-lg md:text-xl leading-relaxed tracking-wider lg:px-0 px-0 ">
            Please see the{" "}
            <a href="/admission-process" className="text-[#A22877]">
              Admission Process
            </a>{" "}
