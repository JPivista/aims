        ...
        />
         ...
         <div className="relative mx-auto">
          ...
          <div 
            ...
            style={{
              background: 'linear-gradient(270deg, var(--Aims-Blue, #0C2165) 0%, var(--Aims-Blue, #0C2165) 35%, rgba(12, 33, 101, 0.00) 100%)'
            }}
          ></div>
          ...
          <div className="absolute inset-0 flex items-center justify-end ">
            <div className="w-2/4 md:px-10">
              ...
              One Degree.<br/>Multiple Targets.
              </h2>
              <p className="text-white text-xs sm:text-sm md:text-base monser-400 leading-relaxed">
                Our BBA graduates have found opportunities with a wide range of dependable recruiters from across industries, including:
              </p>
            </div>
          </div>
        </div>
