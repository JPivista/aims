      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-start pl-0 md:pl-8">
            <h3 className="text-[32px] lg:text-[56px] playfair-300 text-[#0C2165] mb-6 text-start">
            ...
            <div>
              ...
              {hasMoreContent && (
                <button
                  ...
                  className="mt-4 inline-block text-xl font-semibold text-[#000] hover:underline cursor-pointer monser-600"
                >
                  Read More
                </button>
              )}
