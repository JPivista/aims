...
const EventsForACause = () => {
  return (
    <div className="w-full bg-white pb-10 lg:px-8 px-4">
          ...
          <div className="flex flex-col justify-center lg:order-1 order-2">
            ...
            <div>
              <p>
                ...
                hosting events that educate, engage and inspire the community,
                we aim to create meaningful change and positive impact. We
                believe that events can be a powerful catalyst for social
                change, and we are dedicated to using our platform to make a
                difference.
              </p>
            </div>
          </div>
