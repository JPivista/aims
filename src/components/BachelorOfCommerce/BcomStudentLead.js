...
const BcomStudentLead = () => {
    const bcomStudentLeadData = {
        mobileImage: "/bcom/companies-our-graduated-mobile.webp",
        desktopImage: "/bcom/companies-our-graduated.webp",
    ...
    return (
        <StudentLeadSection
            ...
            backgroundClassName="bg-[url('/bcom/companies-our-graduated-mobile.webp')] lg:bg-[url('/bcom/companies-our-graduated.webp')]"
        />
    )
}
