    ...
    <>
      <div className="px-4 lg:px-8">
        <div className="container mx-auto py-10 space-y-12">
          {/* EUHOFA Section */}
          <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-8 border-b pb-8">
            ...
            <div className="lg:col-span-2 order-2 lg:order-1">
              ...
              <p className="text-black mb-6 leading-relaxed">
                ...
                development of the hotel sector and its impact on hotel
              ...
              <p className="text-black mb-6 leading-relaxed">
                ...
                directors and deans of these institutions, leaders in their
                territory.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-8">
            ...
            <div className="lg:col-span-2 order-2 lg:order-1">
              <h4 className="text-xl lg:text-[24px] font-bold text-[#000000] monser-600 mb-3">
                AIMS School of Hospitality & Tourism is associated with HOSCO
                which manages and operates a private online community that
                brings together leading employers, schools and top talents of
              ...
              <p className="text-black mb-6 leading-relaxed">
                ...
                provides an amazing opportunity for the students and alumni of
                AIMS to start their professional careers on a global platform
                and make their mark.
              </p>
            </div>
