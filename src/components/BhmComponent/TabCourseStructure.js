                  ...
                  <div className="flex flex-wrap gap-2">
                    {section.tabs.map((tab) => (
                      <button
                        ...
                        className={`px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-medium transition-all duration-200 border-[0.5px] monser-400
                          ${activeTab === tab.key
                                    ...
                                    return (
                                      ...
                                      <li key={index} className="flex items-start">
                                        <div className="w-full">
                                          <h6 className="monser-400 text-base md:text-[20px] mb-2 mt-4 first:mt-1">
                                            {course.text}
                                          </h6>
                                        </div>
                                      </li>
