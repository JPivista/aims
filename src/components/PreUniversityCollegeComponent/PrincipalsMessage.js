        ...
        <section className="bg-[#E1F9F4] py-12 px-6 lg:px-20">
            <div className="grid grid-cols-1 md:grid-cols-[40%_60%] gap-10 items-center">
                ...
                <div className="flex flex-col justify-center items-center h-full">
                    <div className="relative w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] lg:w-[300px] lg:h-[300px] flex items-center">
                        <Image
