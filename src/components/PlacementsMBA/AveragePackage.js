    ...
    <>
      <div className="lg:px-8 px-4">
        <div className="container mx-auto flex lg:flex-row flex-col-reverse py-10 justify-center items-center gap-10">
          <div className="flex flex-col items-center justify-center lg:gap-5  lg:w-1/2">
            ...
            <p>
              ...
              alignment, practical training, and placement-readiness. It’s a
              clear indicator of our commitment to being among the top business
              schools in India for postgraduate studies.
            </p>
          </div>
