          ...
          <div className="container mx-auto py-6 lg:py-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
              {displayedCampus.map((campus) => (
                <div
                  key={campus.id}
                  className="bg-[#E1F9F4] rounded-lg overflow-hidden transition-shadow duration-300 border-b border-gray-200"
                >
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-4 lg:mb-5">
                      ...
                      <div className="lg:w-1/3">
                        {campus.acf && campus.acf.thumbnail_image ? (
                          <div className="h-48 sm:h-56 lg:h-64 md:h-96 relative overflow-hidden rounded-lg">
                            <Image
