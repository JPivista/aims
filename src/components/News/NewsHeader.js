        ...
        <>
            ...
            <div className='justify-center items-center flex flex-col lg:px-0 px-4 relative overflow-hidden'>
                <div className='container mx-auto py-10 border-b border-gray-200'>
                    <div className='w-[75%] mx-auto text-center flex flex-col gap-4 justify-center items-center'>
                        <h5 className='text-center text-3xl monser-600 text-[#0C2165]'>
                            Latest Updates from AIMS Institutes
                        </h5>
                        <p>
                            Discover the stories of a dynamic student community and the innovations in our cutting-edge business curriculum in Bangalore. Explore the latest updates and chart your course with AIMS Institutes, where education meets direction and potential hits its mark.
                        </p>
                    </div>
                </div>
            </div>
