...
const Aboutpage = () => {
  return (
    <section className="py-10 space-y-10 ">
      ...
      <div>
      <h3 className="container mx-auto  text-[#0C2165] playfair-300 mb-3 md:mb-6 leading-tight  px-4">
          Empowering Minds <br /> Since 1994
        </h3>
        <div className="bg-[#E0F7F4] mt-6 p-6 rounded-md ">
      ...
      <h3 className=" container mx-auto  text-[#0C2165] playfair-300 mb-3 md:mb-6 leading-tight px-4">
        ...
        <p className=" mt-6 container mx-auto px-4 ">
          Our learning culture promotes enquiry, innovation, and impact. 
          As one of the best MBA colleges in Bangalore, our management programs
          are designed to deliver both breadth and depth, equipping students to
          lead in a competitive, globalised world. Meanwhile, our hospitality,
