  ...
  return (
    <>
      <div className="relative w-full h-[100vh] overflow-hidden">
        {/* Background Image */}
        <Image
          src="/student-development/hero-banner.png"
        ...
        <Image
          src="/student-development/mobile-banner.png"
          alt="Admission process"
          width={1920}
          height={1080}
        ...
        <div className="absolute inset-0 w-full flex flex-col justify-end md:ml-15 mb-10 text-center md:text-left">
          ...
          <div className="relative z-10">
            <h2 className="text-white text-3xl md:text-[66px] playfair-300 leading-tight tracking-wider">
