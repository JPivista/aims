  ...
  return (
    <>
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-16 py-6 md:py-10 ">
          {/* Left Side - Content */}
          <div className="flex flex-col md:flex-row gap-4 md:gap-10">
            <div className="space-y-4 md:space-y-6 lg:space-y-6 md:w-2/4">
              ...
              <p className="text-base  md:text-base lg:text-base monser-400">
                Founded in 2007, the AIMS Centre for Student Development (ACSD)
                is built on a singular principle, to walk alongside students
                through every phase of their academic and personal journey. At
                the heart of ACSD lies a belief in the power of mentorship and
                personalised attention, enabling students to build confidence,
                self-awareness, and meaningful life skills.
              </p>
              <p className="text-base  md:text-base lg:text-base monser-400">
                ...
                pre-placement training for graduates, every initiative is
                designed to foster holistic growth. Because at AIMS, we don't
                just prepare students to graduate we prepare them to thrive.
              </p>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-0 pb-6 md:pb-10 ">
          {/* Left Side - Image */}
          ...
          {/* Right Side - Content */}
          <div className="w-full lg:w-2/3 space-y-4 md:space-y-6 px-0 md:px-10">
            ...
            <p className="text-base md:text-base lg:text-base  monser-400">
              ...
              challenges, ACSD ensures that each student experiences their time
              at AIMS as a transformative journey, not just an academic one.
            </p>
            <p className="text-base sm:text-lg md:text-base lg:text-base monser-400">
              ...
              touchpoint for care, structure, and encouragement. The emphasis is
              always on student well-being initiatives in Bangalore colleges
              that are practical, human, and future-focused.
            </p>
          </div>
        </div>
