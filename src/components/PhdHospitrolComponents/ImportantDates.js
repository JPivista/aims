...
const tabData = [
  ...
  },
  {
    ...
    content: (
      <>
        <h6 style={{ color: "#A22877", fontSize: "1.2rem", fontWeight: '600' }} className="text-[#932c79] font-semibold text-lg sm:text-xl mb-3">
          Any candidate who meets the following requirements is eligible to seek registration for a Ph.D program :
        </h6>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 text-gray-800 text-sm sm:text-base space-y-1">
          <li>Admission to Ph.D. shall be through an Entrance Test only.</li>
          ...
          <li>The Entrance Test consists of one paper on the broad area of Ph.D., lasting 3 hours and worth 100 marks.</li>
          ...
          <li>A candidate must secure at least 55 marks out of 100 (50 marks for SC/ST candidates) to be eligible to apply for admission to the Ph.D. program.</li>
          <li>Successful completion of the Entrance Test implies eligibility for admission but does not guarantee entry into the Ph.D. degree program.</li>
          ...
          <li>The Entrance Test process is applicable to all candidates pursuing Ph.D. research under the University and all affiliated research centres.</li>
        </ul>
      </>
    ),
  },
