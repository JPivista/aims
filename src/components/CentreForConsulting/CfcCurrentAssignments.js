                        ...
                        <div className='overflow-x-auto border border-gray-200 rounded-lg'>
                            <table className='w-full min-w-[800px] bg-white'>
                                <thead className='bg-[#531675] text-white sticky top-0'>
                                    <tr>
                                        <th className='px-4 py-3 text-left monser-600 text-sm lg:text-base border-r border-gray-300 w-1/3'>
                                            Company
                                        </th>
                                        <th className='px-4 py-3 text-left monser-600 text-sm lg:text-base border-r border-gray-300 w-1/3'>
                                            Website
                                        </th>
                                        <th className='px-4 py-3 text-left monser-600 text-sm lg:text-base w-1/3'>
