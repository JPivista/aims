...
const HeroBannerCfi = ({ announcements, pageType = 'engineering' }) => {
    return (
        <>
            <div className="relative w-full h-[100vh] overflow-hidden">
                {/* Background Image */}
                <Image
                    src="/centre-for-international-liaison/centre-for-international-liaison-herobanner.png"
                    alt="Centre for International Liaison"
                    width={1920}
                    height={1080}
                        ...
                        <div className="flex lg:flex-row flex-col items-center justify-between md:gap-10 gap-4">
                            <div className="flex items-center">
                                <h1 className="text-white text-2xl lg:text-[60px] playfair-300 lg:leading-16">
                                    AIMS Centre for <i class="fas fa-yandex-international    "></i>
