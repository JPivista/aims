...
const page = () => {
    const seoField = {
        ...
        description: "Explore green campus initiatives in Bangalore at AIMS. Learn about environmental sustainability education in Bangalore and how to create a sustainable college campus.",
